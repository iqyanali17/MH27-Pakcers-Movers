    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Our Services in Akola</h2>
          ...
          <div className="flex flex-col md:flex-row gap-12 mb-16">
            ...
            <div className="bg-blue-50 p-8 rounded-lg shadow-md flex-1">
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-6">
                ...
                <div className="flex items-center p-3 rounded-lg bg-white shadow-md hover:shadow-lg transition-shadow duration-300 hover:bg-blue-50 cursor-pointer">
                  <span className="text-gray-700 hover:text-blue-700 transition-colors duration-300">Balapur</span>
                </div>
                <div className="flex items-center p-3 rounded-lg bg-white shadow-md hover:shadow-lg transition-shadow duration-300 hover:bg-blue-50 cursor-pointer">
                  <span className="text-gray-700 hover:text-blue-700 transition-colors duration-300">Murtizapur</span>
                </div>
                <div className="flex items-center p-3 rounded-lg bg-white shadow-md hover:shadow-lg transition-shadow duration-300 hover:bg-blue-50 cursor-pointer">
                  <span className="text-gray-700 hover:text-blue-700 transition-colors duration-300">Akot</span>
                </div>
                <div className="flex items-center p-3 rounded-lg bg-white shadow-md hover:shadow-lg transition-shadow duration-300 hover:bg-blue-50 cursor-pointer">
                  <span className="text-gray-700 hover:text-blue-700 transition-colors duration-300">Patur</span>
                </div>
                <div className="flex items-center p-3 rounded-lg bg-white shadow-md hover:shadow-lg transition-shadow duration-300 hover:bg-blue-50 cursor-pointer">
                  <span className="text-gray-700 hover:text-blue-700 transition-colors duration-300">Telhara</span>
                </div>
              </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Honest pricing and transparent communication with absolutely no hidden charges</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Premium packing materials and state-of-the-art equipment for maximum safety</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Personalized service and meticulous attention to every detail of your move</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md mb-16">
            ...
            <div className="space-y-4">
              <div className="border-b pb-4 hover:bg-blue-50 transition-all duration-300 transform hover:scale-[1.02] rounded-lg">
                ...
                <p className="text-gray-600">Local moving within Akola typically takes 3-7 hours for 1-2 BHK and 5-10 hours for 3+ BHK, depending on volume and distance.</p>
              </div>
              <div className="border-b pb-4 hover:bg-blue-50 transition-all duration-300 transform hover:scale-[1.02] rounded-lg">
              ...
              <div className="pb-4 hover:bg-blue-50 transition-all duration-300 transform hover:scale-[1.02] rounded-lg">
                ...
                <p className="text-gray-600">You can call us at +91 12345 67890, fill the quote form on our website, or visit our office in Akola for a free survey and quotation.</p>
              </div>
            </div>
          </div>
