        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              MH27 Packers & Movers - Professional relocation services in Solapur with reliable packing and moving solutions.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Why Choose MH27 in Solapur?</h2>
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">Textile Hub</h3>
                    <p className="text-gray-600">Strategic location serving industrial and commercial needs.</p>
                  </div>
                </div>
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Our Services in Solapur</h2>
              <div className="space-y-4">
